...
$resources.onclick = () => {
    ...
    document.getElementById("cause").innerHTML ="Avoid all things plastic. Belive in Reduce, Reuse and Recycle.";
} 
$people.onclick = () => {
    ...
    document.getElementById("cause").innerHTML ="Never waste  food. Rather offer it to people or animals who are in need.";
} 
